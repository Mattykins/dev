(() => {
  ...
  // ../phaser-genesis/src/renderer/webgl1/renderpass/ClearTextures.ts
...
void main (void)
{
  ...
  // ../phaser-genesis/src/renderer/webgl1/renderpass/SetDefaultTextures.ts
  ...
  // examples/src/gameobjects/animatedsprite/atlas animation.ts
  var Demo = class extends Scene {
    constructor() {
      ...
      loader.start().then(() => {
        ...
        const lay = CreateAnimationFromAtlas({ key: "lay", texture: "chicken", prefix: "__orange_chicken_lay_egg_", end: 9, zeroPad: 3 });
        const idle = CreateAnimationFromAtlas({ key: "idle", texture: "chicken", prefix: "__orange_chicken_idle_", end: 19, zeroPad: 3 });
        const peck = CreateAnimationFromAtlas({ key: "peck", texture: "chicken", prefix: "__orange_chicken_peck_", end: 9, zeroPad: 3 });
        Play(lay, { repeat: -1, frameRate: 16, delay: 1e3, repeatDelay: 4e3 }, chicken1);
        Play(idle, { repeat: -1, frameRate: 24, repeatDelay: 1e3 }, chicken2);
        Play(peck, { repeat: -1, frameRate: 24, delay: 2e3, repeatDelay: 3e3 }, chicken3);
        AddChildren(world2, bg, chicken1, chicken2, chicken3);
      });
    }
  };
  new Game(WebGL(), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(5832972), Scenes(Demo));
})();
//# sourceMappingURL=atlas animation.js.map
